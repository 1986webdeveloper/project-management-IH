...
const Project = ({ projectList, clientList, employeeList, managerList }: ProjectProps) => {
			...
			>
				<div className="grid py-7 grid-rows-5 text-blue-950 grid-flow-col  items-start w-[100%]">
					...
					<AntSelect
						...
						value={isEdit ? projectDetails.clientId.clientName : projectDetails.clientId}
					...
					<AntSelect
						...
						value={isEdit ? projectDetails.reportingManager.name : projectDetails.reportingManager}
						onFocus={() => {
					...
					<AntMultiSelect
						width={330}
						value={
							isEdit ? ModuleList(projectDetails.assignedEmployeeList, 'name') : projectDetails.assignedEmployeeList
						}
